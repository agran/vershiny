...
/**
 * Компас: роза ветров с залитой стрелкой — кнопка «Включить компас» (iOS).
 *
 * Северная половина стрелки залита целиком, южная — полупрозрачно:
 * указатель читается как направление даже на цветном фоне кнопки.
 */
export const ICON_COMPASS = svg(
  '<circle cx="12" cy="12" r="8.5"/>' +
    '<path d="M12 3.5v1M12 19.5v1M3.5 12h1M19.5 12h1"/>' +
    '<path d="M17.3 6.7l.71-.71M6.7 6.7l-.71-.71M17.3 17.3l.71.71M6.7 17.3l-.71.71"/>' +
    '<path d="M12 5.2 14.3 12 9.7 12z" fill="currentColor" stroke="none"/>' +
    '<path d="M12 18.8 14.3 12 9.7 12z" fill="currentColor" fill-opacity=".35" stroke="none"/>',
);

/**
 * Компас «включи меня» (iOS): стрелка повёрнута на 45° — иконка читается
 * как «не в строю», а не как направление на север. Северная половина
 * стрелки залита целиком, южная — полупрозрачно.
 */
export const ICON_COMPASS_TAP = svg(
  '<circle cx="12" cy="12" r="8.5"/>' +
    '<path d="M12 3.5v1M12 19.5v1M3.5 12h1M19.5 12h1"/>' +
    '<path d="M17.3 6.7l.71-.71M6.7 6.7l-.71-.71M17.3 17.3l.71.71M6.7 17.3l-.71.71"/>' +
    '<path d="M16.8 7.2 13.6 13.6 10.4 10.4z" fill="currentColor" stroke="none"/>' +
    '<path d="M7.2 16.8 13.6 13.6 10.4 10.4z" fill="currentColor" fill-opacity=".35" stroke="none"/>',
);
