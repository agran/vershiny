...
export const ICON_ROTATE_AUTO = svg(
  ...
  '<rect x="9" y="6.5" width="6" height="11" rx="1.5"/>' +
    // левая дуга снизу вверх, наконечник на конце — на боковине, где
    // вокруг свободно и оба крыла стрелки читаются, не сливаясь с дугой
    '<path d="M12 20a8 8 0 0 1-7.8-9.2"/>' +
    '<path d="M1.7 13.1 4.2 10.8l2.5 2.3"/>' +
    // правая дуга сверху вниз, наконечник в конце
    '<path d="M12 4a8 8 0 0 1 7.8 9.2"/>' +
    '<path d="M22.3 10.9 19.8 13.2l-2.5-2.3"/>',
);
