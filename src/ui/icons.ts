...
/** Автоповорот экрана: телефон в круговой дуге (сам поворачивается) */
export const ICON_ROTATE_AUTO = svg(
  '<rect x="9" y="7" width="6" height="11" rx="1.5"/>' +
    // дуга вокруг телефона с двумя наконечниками — «крутится сам»
    '<path d="M5 12a7 7 0 0 1 12.1-4.8"/>' +
    '<path d="M17 3.5v3.7h-3.7"/>' +
    '<path d="M19 12a7 7 0 0 1-12.1 4.8" opacity="0.55"/>' +
    '<path d="M7 20.5v-3.7h3.7" opacity="0.55"/>',
);

/** Маленький замочек для запертых режимов (контурный, не залитый) */
const LOCK_BADGE =
  '<rect x="14" y="14.5" width="7" height="5.5" rx="1"/>' +
  '<path d="M15.8 14.5v-1.7a1.9 1.9 0 0 1 3.8 0v1.7"/>';

/** Заперто в ландшафте: горизонтальный телефон + замок */
export const ICON_ROTATE_LANDSCAPE = svg(
  '<rect x="3" y="8" width="13" height="9" rx="1.5"/>' + LOCK_BADGE,
);

/** Заперто в портрете: вертикальный телефон + замок */
export const ICON_ROTATE_PORTRAIT = svg(
  '<rect x="7" y="4" width="8" height="12" rx="1.5"/>' + LOCK_BADGE,
);
