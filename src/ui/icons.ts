...
/** Поворот экрана: телефон-портрет, поворачиваемый в ландшафт (дуга с наконечником) */
export const ICON_ROTATE = svg(
  // портретный телефон слева внизу
  '<rect x="3" y="9" width="7" height="11" rx="1.5"/>' +
    // дуга поворота: из верхней точки телефона вверх-вправо к ландшафту
    '<path d="M6.5 9V7a4 4 0 0 1 4-4h6.5"/>' +
    // наконечник стрелки на конце дуги
    '<path d="M14 6.5 17 3l-3-3.5"/>' +
    // ландшафтный телефон справа вверху (контур без заливки, прозрачнее)
    '<rect x="13" y="10" width="9" height="6.5" rx="1.5" opacity="0.55"/>',
);
