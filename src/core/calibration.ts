 ...
 *
 *   - **азимут** — компас врёт систематически: магнитное склонение (на Кавказе
 *     около +6°), железо в кармане, соседняя машина. Свайп по кадру двигает
 *     контуры вбок, поправка запоминается;
