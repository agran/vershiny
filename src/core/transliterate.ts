...
/**
 * Диграфы латиницы → кириллица. Порядок важен: длинные раньше коротких,
 * иначе «tsch» разложится как «ts» + «ch».
 *
 * Немецкие сочетания стоят первыми: без них «Schesaplana» превращалась в
 * «Скхесаплану», а «Tschierva» — в «Тсчиерву». В Альпах таких названий
 * больше, чем русских заимствований.
 */
